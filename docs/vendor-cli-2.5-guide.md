...
| CLI 版本 | 维护日期 | 更新内容 |
| --- | --- | --- |
| 2.5.2 | 2026-09-13 | 明确供应商员工不使用工时核对与流程事件；明确交付材料仅查询和下载。 |
...
供应商员工不开放 `work-hours-check` 和 `process-trace`。员工也不通过本 CLI 上传交付材料；上传和交付管理由供应商管理员在平台内完成。
...
本 CLI 只提供交付材料查询和下载，不提供上传、驳回或删除能力。
